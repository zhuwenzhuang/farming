...
const EXPECTED_API_ROUTE_MANIFEST = [
  ...
  'GET /api/files/file',
  'GET /api/files/raw',
  'POST /api/files/previews',
  'GET /api/files/previews/:sessionId/:scope/*',
  'DELETE /api/files/previews/:sessionId',
  'PUT /api/files/file',
  'POST /api/files/move',
  'POST /api/files/entry',
  'PATCH /api/files/entry',
  ...
  'GET /api/computers/:id/viewer',
  'MIDDLEWARE /api/language-server [express.json(limit=1mb)]',
  'GET /api/language-server/capability',
  'POST /api/language-server/request',
