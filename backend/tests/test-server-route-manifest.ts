...
const EXPECTED_API_ROUTE_MANIFEST = [
  ...
  'GET /api/files/raw',
  'GET /api/files/previews/:sessionId/:scope/*assetPath',
  ...
  'POST /api/browsers/:id/control',
  'POST /api/browsers/:id/native-action',
  'POST /api/browsers/:id/select-native-tab',
  'POST /api/browsers/:id/native-tab',
  ...
  'GET /api/computers/:id/viewer/*viewerPath',
  ...
  'GET /api/agents/:agentId/related-sessions',
  'GET /api/agents/:agentId/acp-subagents/:sessionId/transcript',
  ...
  'GET /api/agent-sessions/:provider/:sessionId/resume-status',
