...
assert.strictEqual(validateClientMessage({ type: 'watch-acp-transcripts', agentIds: [], subagentParentKeys: ['parent'] }).ok, true);
assert.strictEqual(validateClientMessage({ type: 'watch-acp-transcripts', agentIds: [], subagentParentKeys: ['parent', 'parent'] }).ok, false);
assert.strictEqual(validateClientMessage({ type: 'watch-acp-transcripts', agentIds: [], subagentParentKeys: [42] }).ok, false);
