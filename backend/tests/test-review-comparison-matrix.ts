...
type ComparisonCase = [string, () => Promise<void>, string[]];
type UnstagedComparisonCase = [string, () => Promise<void>, string[], boolean];
...
async function run() {
  ...
  try {
    ...
    const stagedCases: ComparisonCase[] = [
    ...
    const unstagedCases: UnstagedComparisonCase[] = [
