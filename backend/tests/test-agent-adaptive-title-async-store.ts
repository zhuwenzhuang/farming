...
async function run() {
  ...
  try {
    ...
    const agent = {
      ...
      providerSessionKey: encodeProviderSessionKey('codex', 'async-title-session', 'default'),
    ...
    const configAgent = {
      ...
      providerSessionKey: encodeProviderSessionKey('codex', 'config-title-session', 'default'),
      agentRecordId: '',
      persistentSessionId: '',
    };
