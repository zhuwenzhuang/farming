...
(() => {
    ...
    const requiredElement = (selector) => {
        ...
        if (!element)
            throw new Error(`Farming Net is missing required element: ${selector}`);
        return element;
    };
    ...
    const elements = {
        count: requiredElement('#instance-count'),
        empty: requiredElement('#empty-state'),
        grid: requiredElement('#instance-grid'),
        notice: requiredElement('#notice'),
        refresh: requiredElement('[data-testid="net-refresh"]'),
        search: requiredElement('[data-testid="net-search"]'),
        subtitle: requiredElement('#portal-subtitle'),
        title: requiredElement('#portal-title'),
