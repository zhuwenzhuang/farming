...
在 52 Weeks 详情中，鼠标在某个日期上短暂停留后才会更新逐小时图表；快速扫过多个日期时，当前图表保持稳定。点击、键盘聚焦和手机日期控件仍然立即选中日期。
