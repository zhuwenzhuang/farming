...
> Chinese version: [guide.zh_cn.md](./guide.zh_cn.md)
...
Farming Net is currently started from a Farming source checkout; it is not a
subcommand of the globally installed `farming` CLI.

```bash
git clone https://github.com/zhuwenzhuang/farming.git
cd farming
npm ci
```
