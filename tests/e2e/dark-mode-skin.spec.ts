...
test.describe('Farming Code appearance skins', () => {
  ...
  test('applies Paper across the browser canvas, workbench, settings, and terminal', async ({ page, workspaceRoot }) => {
    ...
    await expect(page.getByTestId('app-shell')).toHaveCSS('background-color', 'rgb(247, 244, 236)')
    await expect(page.getByTestId('code-sidebar')).toHaveCSS('background-color', 'rgb(247, 244, 236)')
    ...
    await expect(searchBox).toHaveCSS('background-color', 'rgb(255, 254, 250)')
    ...
    await expect(appearanceSwatches.nth(3)).toHaveCSS('background-color', 'rgb(247, 244, 236)')
    ...
    await expect(page.getByTestId('input-dialog')).toHaveCSS('background-color', 'rgb(247, 244, 236)')
    ...
    await expect(page.locator('.code-project-row').first()).toHaveCSS('background-color', 'rgb(247, 244, 236)')
    await expectTerminalAppearance(page, agentId, 'paper')
    await chooseAppearance(page, 'Light')
    await expect(page.locator('.code-project-row').first()).toHaveCSS('background-color', 'rgb(247, 247, 246)')
  ...
  test('applies and verifies the dark Codex skin across core surfaces', async ({ page, workspaceRoot }, testInfo) => {
    ...
    await expect(page.locator('.code-project-row').first()).toHaveCSS('background-color', 'rgb(36, 36, 36)')
    ...
    await expect(page.locator('.code-plugin-desktop-target').first()).toHaveCSS('background-color', 'rgb(28, 28, 28)')
    ...
    await expect(page.locator('.code-plugin-extension-kind-tabs')).toHaveCSS('background-color', 'rgb(28, 28, 28)')
    await expect(page.locator('.code-plugin-extension-list')).toHaveCSS('border-color', 'rgb(56, 56, 56)')
    await expect(page.locator('.code-plugin-extension').first()).toHaveCSS('border-bottom-color', 'rgb(42, 42, 42)')
    await page.locator('.code-plugin-extension').first().click()
    const pluginDetailDialog = page.getByTestId('code-plugin-detail-dialog')
    await expect(pluginDetailDialog).toHaveCSS('background-color', 'rgb(38, 38, 38)')
