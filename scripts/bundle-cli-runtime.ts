...
const packagedCodexEntry = path.join(projectRoot, 'dist', 'acp', 'codex-acp-1.11.0.mjs');
const packagedClaudeEntry = path.join(projectRoot, 'dist', 'acp', 'claude-agent-acp-0.76.0.mjs');
