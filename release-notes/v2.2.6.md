...
- **Review and file workflows are substantially deeper**: Project Files, Changes, Open Editors, search, preview, diff, blame, review snapshots, comments, preferences, and patchset state now form one project-scoped workflow.
...
- Farming now relies on the target system runtime for Node.js and native dependencies. It does not bundle or select a private system C library.
