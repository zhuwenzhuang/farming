...
- **File workflows are substantially deeper, with a first-class Review surface**: Project Files, Changes, Open Editors, search, preview, diff, and blame are product workflows; the standalone `/review` route now provides immutable comparisons, inline comments, reviewed state, preferences, patchsets, and ACP historical-change capture.
