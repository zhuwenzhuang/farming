...
- Included Code workspace desktop and mobile shell changes made after `v2.2.2`.
...
- `src/components/CodeWorkspace.tsx`, `src/components/code/*`, `src/components/files/*`, `src/lib/workspace-*`: Farming Code workspace, mobile layout, and Project Files changes.
...
- `backend/agent-env.js`, `backend/agent-manager.js`, `backend/*session-engine*.js`, `backend/shell-busy-integration.js`, `backend/terminal-status.js`: Agent environment, Terminal state, and Native PTY lifecycle changes.
