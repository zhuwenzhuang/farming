...
- **Packaged CLI smoke extends the cold-start wait**: Daemon startup allows more time for the packaged server to finish cold-start extraction and create its token file.
