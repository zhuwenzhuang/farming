...
export function SubagentBody({ agent: structuralAgent, active, renderComposer, onOpenFile, onReadLatest, onQuoteSelection, copy }: {
  agent: Agent
  active: boolean
  ...
  return <>
    <AcpTranscriptPane agentId={agent.id} readingIdentity={agent.providerSessionKey}
      ...
      onReadLatest={readLatest} onOpenWorkspaceFilePath={onOpenFile} onQuoteSelection={quoteSelection} />
