...
export function BackToAgentGlyph(props: IconGlyphProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" {...props}>
...
export function SpeedGlyph(props: IconGlyphProps) {
  return (
...
export function TerminalSquareGlyph(props: IconGlyphProps) {
  return (
...
export function ChatBubblesGlyph(props: IconGlyphProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" {...props}>
...
export function NewAgentGlyph(props: IconGlyphProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" {...props}>
...
export function HistoryGlyph(props: IconGlyphProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" {...props}>
...
export function FocusModeGlyph(props: IconGlyphProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false" {...props}>
