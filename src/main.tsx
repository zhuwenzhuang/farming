...
async function renderApplication() {
  ...
  await import('./styles/git-history.css')
  await import('./styles/composer.css')
  await import('./styles/plugin.css')
  await import('./styles/settings.css')
  await import('./styles/share.css')
  await import('./styles/sidebar-resources.css')
  await import('./styles/usage.css')
  await import('./styles/markdown.css')
  await import('./styles/search.css')
  await import('./styles/history.css')
  await import('./styles/empty.css')
  await import('./styles/language-server.css')
  await import('./styles/desktop-backend.css')
  await import('./styles/terminal.css')
