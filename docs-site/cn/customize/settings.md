...
<ThemeImage light="/cn/assets/settings.png" dark="/cn/assets/settings-dark.png" paper="/cn/assets/settings-paper.png" alt="Farming 设置" />

> 文档截图使用英文界面，以便自动生成结果保持稳定。可以在 Settings 顶部随时切换中文或英文。

## 外观与语言

Settings 顶部可以选择跟随系统、浅色、深色或 Paper 外观，并切换中文或英文界面。Paper 使用单一暖白画布和米灰色块，通过留白代替多余边框与阴影；强调色只用于按钮、链接与少量状态。跟随系统只会在浅色与深色之间切换，Paper 始终需要显式选择。
...
<ThemeImage
  ...
  paper="/cn/assets/pet-soft-glow-paper.png"
