...
![Prepare the connector in Farming](/en/assets/existing-chrome-install.webp)
...
2. In the file picker, open your home folder, select **farming-browser-connector**, then click **Select**.
   ...
   ![Select farming-browser-connector](/en/assets/existing-chrome-select-folder.webp)

3. Open Chrome's **Extensions** menu and click
   **Farming Browser Connector**.

   ![Open the connector](/en/assets/existing-chrome-menu.webp)
...
![Remove Farming Browser Connector](/en/assets/existing-chrome-remove.webp)
