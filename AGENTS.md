...
- `browserExtensionEnabled` (disabled by default; enables the system-browser-backed shared Browser Extension only when a compatible executable is available)
