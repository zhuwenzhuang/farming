...
具体截图、安装方式和产品说明见 [Farming 2 产品介绍](./docs/products/code/README.zh_cn.md)。Gas City 风格的托管任务皮肤概念见 [Farming Hive](./docs/products/hive/README.zh_cn.md)。
...
│   └── products/hive/       # Gas City 风格托管任务皮肤概念
├── config/                  # 部署 / 安装配置模板
